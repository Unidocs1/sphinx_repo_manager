...
Single doc - a content fragment of [the master doc](https://source.goxbe.io/Core/docs/sphinx_repo_manager) - is used to create help docs with `make html` (`sphinx-build`). 
