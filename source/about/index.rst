...
builds upon open source technology, such as `Composer.js <https://www.composerjs.io>` and
`Kubernetes <https://kubernetes.io/>`, to create the industry's most customizeable and feature-rich online gaming
platform.

The team behind **AcceleratXR**, pronounced simply *accelerator* (`/əkˈseləˌrādər/`), built the platform with the
ambitious goal to dramatically **Accelerate** E\**x**\tended **R**\eality product development. With this goal in mind
