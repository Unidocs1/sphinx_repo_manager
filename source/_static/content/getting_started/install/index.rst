...
The Xsolla Backend backend platform can be easily installed anywhere that Kubernetes operates.
...
Xsolla Backend Helm Chart
======================

A `Helm chart <https://helm.sh/>`_ is a package for deploying a set of Kubernetes resources. The Xsolla Backend Helm Chart makes it easy to deploy
...
Xsolla Backend Operator for Kubernetes
===================================
...
cluster that is capable of managing custom resource definitions (CRDs). The Xsolla Backend Operator for Kubernetes is used to manage `acceleratxr.com/Cluster`
