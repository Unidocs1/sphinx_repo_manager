...
.. list-table::
   ...
   * - Property
     ...
     - Unique
     - Required
   * - `name <restapi/QuestDefinition#name>`_
     ...
     - true
     - true
   * - `title <restapi/QuestDefinition#title>`_
     ...
     - false
     - true
   * - `description <restapi/QuestDefinition#description>`_
     ...
     - false
     - true
   * - `icon <restapi/QuestDefinition#icon>`_
     ...
     - false
     - true
   * - `entityUid <restapi/QuestDefinition#entityUid>`_
     ...
     - false
     - true
   * - `requirements <restapi/QuestDefinition#requirements>`_
     ...
     - false
     - true
   * - `rewards <restapi/QuestDefinition#rewards>`_
     ...
     - false
     - true
   * - `dateAvailable <restapi/QuestDefinition#dateAvailable>`_
     ...
     - false
     - true
   * - `dateFinished <restapi/QuestDefinition#dateFinished>`_
     ...
     - false
     - true
   * - `frequency <restapi/QuestDefinition#frequency>`_
     ...
     - false
     - true
   * - `unlockRequirements <restapi/QuestDefinition#unlockRequirements>`_
     ...
     - false
     - true
   * - `autostart <restapi/QuestDefinition#autostart>`_
     ...
     - false
     - true
   * - `data <restapi/QuestDefinition#data>`_
...
.. list-table::
   ...
   * - Member
     ...
     - Unique
     - Required
   * - `type <restapi/QuestRequirement#type>`_
     ...
     - false
     - true
   * - `title <restapi/QuestRequirement#title>`_
     ...
     - false
     - true
   * - `description <restapi/QuestRequirement#description>`_
     ...
     - false
     - true
   * - `icon <restapi/QuestRequirement#icon>`_
     ...
     - false
     - true
   * - `value <restapi/QuestRequirement#value>`_
...
.. list-table::
   ...
   * - Member
     ...
     - Unique
     - Required
   * - `type <restapi/QuestReward#type>`_
     ...
     - false
     - true
   * - `quantity <restapi/QuestReward#quantity>`_
     ...
     - false
     - true
   * - `entityUid <restapi/QuestReward#entityUid>`_
...
.. list-table::
   ...
   * - Member
     ...
     - Unique
     - Required
   * - `questUid <restapi/Quest#questUid>`_
     ...
     - false
     - true
   * - `personaUid <restapi/Quest#personaUid>`_
     ...
     - false
     - true
   * - `progress <restapi/Quest#progress>`_
     ...
     - false
     - true
   * - `completions <restapi/Quest#completions>`_
     ...
     - false
     - true
   * - `dateLastCompleted <restapi/Quest#dateLastCompleted>`_
     ...
     - false
     - true
   * - `dateLastStarted <restapi/Quest#dateLastStarted>`_
     ...
     - false
     - true
   * - `unlocked <restapi/Quest#unlocked>`_
     ...
     - false
     - true
   * - `unlockProgress <restapi/Quest#unlockProgress>`_
...
.. list-table::
   ...
   * - Member
     ...
     - Unique
     - Required
   * - `requirementUid <restapi/QuestProgress#type>`_
     - The unique identifier of the quest requirement being tracked.
     - ``string``
     - 
     - ``""``
     - false
     - false
     - true
   * - `value <restapi/QuestProgress#value>`_
